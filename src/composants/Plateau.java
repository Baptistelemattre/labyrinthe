...
public class Plateau {
	...
	// Calcul le nombre de passage possible par rapport au chemin d�j� emprunter.
	public int nbPassagePossible(int ligActuelle,int colActuelle, boolean[][] pieceNonVisitee) { //Changer en nombre d'entr�es possible actuelle vers de nouvelles cases
		int nbEntrees = 0;
	...
	//Calcul le nombre de chemin possible depuis une case pr�cise.
	public int nbPassagePossiblePiece(int ligActuelle,int colActuelle) { //Changer en nombre d'entr�es possible actuelle vers de nouvelles cases
		int nbEntrees = 0;
